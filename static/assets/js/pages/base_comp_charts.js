...
var BaseCompCharts = function() {
    ...
    var initChartsChartJS = function () {
       ...
       // var $chartPolarCon  = jQuery('.js-chartjs-polar')[0].getContext('2d');
        ...
        var $chartPieCon2    = jQuery('.js-chartjs-pie2')[0].getContext('2d');
        ...
        var $chartPolarPieDonutData = [
            ...
            {
                value: 12,
                color: 'rgba(17, 176, 235, 1)',
                highlight: 'rgba(117, 176, 235, .75)',
                label: 'Tickets'
            },
            {
                value: 22,
                color: 'rgba(317, 176, 235, 1)',
                highlight: 'rgba(117, 176, 235, .75)',
                label: 'Tickets'
            },
            {
                value: 32,
                color: 'rgba(217, 176, 235, 1)',
                highlight: 'rgba(117, 176, 235, .75)',
                label: 'Tickets'
            }
        ];
        var $chartPolarPieDonutData2 = [
            {
                value: 6,
                color: 'rgba(71, 327, 125, 1)',
                highlight: 'rgba(171, 227, 125, .75)',
                label: 'Earnings'
            },
            {
                value: 5,
                color: 'rgba(471, 427, 25, 1)',
                highlight: 'rgba(171, 227, 125, .75)',
                label: 'Earnings'
            },            {
                value: 4,
                color: 'rgba(171, 277, 185, 1)',
                highlight: 'rgba(171, 227, 125, .75)',
                label: 'Earnings'
            },            {
                value: 3,
                color: 'rgba(571, 287, 185, 1)',
                highlight: 'rgba(171, 227, 125, .75)',
                label: 'Earnings'
            },            {
                value: 2,
                color: 'rgba(471, 427, 425, 1)',
                highlight: 'rgba(171, 227, 125, .75)',
                label: 'Earnings'
            },            {
                value: 16,
                color: 'rgba(271, 127, 125, 1)',
                highlight: 'rgba(171, 227, 125, .75)',
                label: 'Earnings'
            },
            {
                value: 12,
                color: 'rgba(150, 219, 125, 1)',
                highlight: 'rgba(250, 219, 125, .75)',
                label: 'Sales'
            },
            {
        ...
        $chartPie = new Chart($chartPieCon, {type: 'pie', data: $chartPolarPieDonutData, options: $globalOptions});
        $chartPie = new Chart($chartPieCon2, {type: 'pie', data: $chartPolarPieDonutData, options: $globalOptions});
        //
        // $chartPie2   = new Chart($chartPieCon2).Pie($chartPolarPieDonutData2, $globalOptions);
